              ...
              routes: [
                {
                  name: 'APNS',
                  icon: 'crown',
                  path: '/push_service/apple_apns',
                  component: './push_service/apple_apns',
                },
                {
                  name: 'FCM',
                  icon: 'crown',
                  path: '/push_service/google_fcm',
                  component: './push_service/google_fcm',
                },
                {
                  name: 'HuaWei HMS',
                  icon: 'crown',
                  path: '/push_service/huawei_hms',
                  component: './push_service/huawei_hms',
                },
                {
                  name: 'XiaoMi Push',
                  icon: 'crown',
                  path: '/push_service/xiaomi_push',
                  component: './push_service/xiaomi_push',
                },
                {
                  name: 'OPPO Push',
                  icon: 'crown',
                  path: '/push_service/opop_push',
                  component: './push_service/opop_push',
                },
                {
                  name: 'Vivo Push',
                  icon: 'crown',
                  path: '/push_service/vivo_push',
